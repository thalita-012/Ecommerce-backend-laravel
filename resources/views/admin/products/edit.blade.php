...
<div class="page-header-wrapper">
    ...
    <div class="page-subtitle">Update parameters, inventory amounts, pricing configurations, or image files.</div>
</div>
                ...
                <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" 
                               id="name" name="name" value="{{ old('name', $product->name) }}" autocomplete="off" required>
                        @error('name')
                    ...
                    <div class="mb-4">
                        ...
                        @if($product->image)
                            <div class="mb-3">
                                <img src="{{ asset('storage/' . $product->image) }}" alt="{{ $product->name }}" class="preview-frame">
                            </div>
                        @endif
                        ...
                        @error('image')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <div class="text-muted small mt-2">Leave unselected to maintain the current image asset.</div>
                    </div>

...
<div class="page-header-wrapper">
    ...
    <div class="page-subtitle">Add a brand new department or collection cluster to your storefront.</div>
</div>
            ...
            <div class="card-body p-4">
                <form action="{{ route('admin.categories.store') }}" method="POST">
                    ...
                    <div class="d-flex gap-2 pt-2">
                        <button type="submit" class="btn btn-action-primary">Create Category</button>
